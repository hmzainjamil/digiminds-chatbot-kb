...
<p align="center">
  <img src="https://raw.githubusercontent.com/hmzainjamil/digiminds-chatbot-kb/main/banner.png" width="100%" />
</p>

<p align="center">
  <a href="https://github.com/hmzainjamil/digiminds-chatbot-kb/stargazers"><img src="https://img.shields.io/github/stars/hmzainjamil/digiminds-chatbot-kb?style=for-the-badge&color=FFD700&labelColor=000" alt="Stars"/></a>
  <a href="https://github.com/hmzainjamil/digiminds-chatbot-kb/forks"><img src="https://img.shields.io/github/forks/hmzainjamil/digiminds-chatbot-kb?style=for-the-badge&color=4FC3F7&labelColor=000" alt="Forks"/></a>
  <a href="https://github.com/hmzainjamil/digiminds-chatbot-kb/issues"><img src="https://img.shields.io/github/issues/hmzainjamil/digiminds-chatbot-kb?style=for-the-badge&color=FF6B6B&labelColor=000" alt="Issues"/></a>
  <a href="https://github.com/hmzainjamil/digiminds-chatbot-kb/pulls"><img src="https://img.shields.io/github/issues-pr/hmzainjamil/digiminds-chatbot-kb?style=for-the-badge&color=A8E6CF&labelColor=000" alt="PRs"/></a>
  <a href="https://github.com/hmzainjamil/digiminds-chatbot-kb/commits/main"><img src="https://img.shields.io/github/commit-activity/m/hmzainjamil/digiminds-chatbot-kb?style=for-the-badge&color=DDA0DD&labelColor=000" alt="Commits"/></a>
  <a href="https://github.com/hmzainjamil/digiminds-chatbot-kb/commits/main"><img src="https://img.shields.io/github/last-commit/hmzainjamil/digiminds-chatbot-kb?style=for-the-badge&color=98FB98&labelColor=000" alt="Last Commit"/></a>
</p>

<p align="center">
  <img src="https://img.shields.io/badge/Stack-Markdown_%C2%B7_JSON_%C2%B7_RAG-optimized-blue?style=flat&labelColor=555" />
  <img src="https://img.shields.io/badge/Type-Knowledge_Base-blue?style=flat&labelColor=555" />
  <img src="https://img.shields.io/badge/Agency-DigiMinds-orange?style=flat&labelColor=555" />
...
DigiMinds is a digital marketing agency specializing in Google Ads, Meta Ads, and SEO/GEO. Every client-facing chatbot needs a structured knowledge base to handle pricing questions, service descriptions, case studies, objection handling, and escalation flows without human intervention — available 24/7 at scale. This KB is the authoritative source of truth for all automated client interactions.

The structure covers: full service catalog with pricing ranges and package descriptions for each service tier, FAQ corpus of 50+ pre-sales questions with structured answers optimized for RAG retrieval, SOP documentation for onboarding, monthly reporting, and billing workflows, escalation decision trees that route complex or high-value queries to human agents, and objection-handling scripts for the 10 most common pushbacks (price, results timeline, contract length, exclusivity).

Designed for integration with any LLM-powered chatbot (GPT-4, Claude, Gemini) via RAG. Each document is chunked to 512 tokens with 50-token overlap and tagged with metadata (topic, service, intent, priority) for optimized retrieval. Sync cadence pulls updates from the agency CRM, Notion project management, and Google Ads/Meta account performance quarterly to keep pricing, case studies, and benchmarks current and credible.
...
| | What you get |
|---|---|
| **Service Catalog** | All services with pricing ranges, deliverables, and timeline expectations |
| **FAQ Corpus** | 50+ pre-sales questions with structured answers optimized for RAG |
| **SOP Library** | Onboarding, reporting, escalation, and billing procedure documentation |
| **Escalation Trees** | Decision logic for routing complex or high-value queries to humans |
| **Objection Scripts** | 10 common pushbacks with evidence-based response frameworks |
| **Case Studies** | Anonymized performance results by industry and service type |
| **Pricing Logic** | Package tiers, add-on services, and volume discount rule documentation |
| **RAG Chunking** | 512-token chunks with 50-token overlap and metadata tags for retrieval |
| **Update Sync** | Quarterly sync from CRM, Notion, and account performance data |
| **Multi-LLM Ready** | Works with GPT-4, Claude, Gemini via standard RAG interface integration |
